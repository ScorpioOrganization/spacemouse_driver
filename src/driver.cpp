...
Driver::Driver(std::shared_ptr<DriverContext> context, std::shared_ptr<ConnectionMethod> conn_method)
: _context(context) {
  ...
  _connection_manager->set_state_change_callback(
        std::bind(&Driver::on_connection_state_change, this, std::placeholders::_1, std::placeholders::_2)
  );
